...
while **dought** has the greatest economic consequences during the last 10 years.
...
It looks like better records were kept from 1995 onwards.
We decide to use the time period of the last 10 years, which matches the
interval used by National Weather Service - [Natural Hazard Statistics]
(http://www.nws.noaa.gov/om/hazstats.shtml).
Note that although 2011 only has records through November, we includ 2011
